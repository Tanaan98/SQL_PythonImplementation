...
y = Table()
z = Table()
x.table = {'m.year':['1997', '2003', '2010'], 'm.title': ['Titantic', 'Lord of Rings', 'Toy Story 3'], 'm.studio': ['Par', 'NL', 'BV']}
y.table = {'o.year': ['2010', '2003', '1997', '1997'], 'o.category': ['Anitmated Film', 'Directing', 'Directing', 'Best Picture'], 'o.title': ['Toy Story 3', 'Lord of Rings', 'Titanic', 'Titantic']}
